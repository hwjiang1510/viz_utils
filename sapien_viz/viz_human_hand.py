...
def parse_args():
    ...
    parser.add_argument('-m', '--model_path', type=str, required=False, help="Path to the MANO hand torch model.")
    return parser.parse_args()


def visualize_articulation(urdf_file):
    # Setup
...
def main():
    args = parse_args()
    visualize_articulation(args.urdf)
